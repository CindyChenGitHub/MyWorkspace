------------------------------------------------------------
-- Display Instance Default Directory Info
------------------------------------------------------------
--Instance Installation Root Info
EXEC master.dbo.xp_instance_regread 
    N'HKEY_LOCAL_MACHINE',
    N'Software\Microsoft\MSSQLServer\Setup',
    N'SQLDataRoot'
--Instance Default Data Director Info
EXEC master.dbo.xp_instance_regread
    N'HKEY_LOCAL_MACHINE',
    N'Software\Microsoft\MSSQLServer\MSSQLServer',
    N'DefaultData'
--Instance Default Log Director Info
EXEC master.dbo.xp_instance_regread
    N'HKEY_LOCAL_MACHINE',
    N'Software\Microsoft\MSSQLServer\MSSQLServer',
    N'DefaultLog'
--Instance Default Backup Director Info
