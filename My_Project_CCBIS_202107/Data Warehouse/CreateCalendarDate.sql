...
SELECT @StartDate = '20200101'  -- Set The start and end date 
, @EndDate = '20210101'  --Non inclusive. Stops on the day before this.
...
--Add new columns as the following:
--ReportWeekNumber,ReportMonthNumber,ReportQuarterNumber,ReportYearNumber,ReportWeekStart
--ReportWeekEnd,ReportMonthName,ReportQuarterName

--run the following select query to make sure the results is you want
